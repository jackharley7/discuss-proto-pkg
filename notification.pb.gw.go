...
var (
	filter_NotificationService_GetNotificationBySubjectIDs_0 = &utilities.DoubleArray{Encoding: map[string]int{"subjectType": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_NotificationService_GetNotificationBySubjectIDs_0(ctx context.Context, marshaler runtime.Marshaler, client NotificationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNotificationBySubjectIDsRequest
	...
	val, ok = pathParams["subjectType"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "subjectType")
	}

	protoReq.SubjectType, err = runtime.String(val)

	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "subjectType", err)
	}

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_NotificationService_GetNotificationBySubjectIDs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetNotificationBySubjectIDs(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_NotificationService_GetNotificationBySubjectIDs_0(ctx context.Context, marshaler runtime.Marshaler, server NotificationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNotificationBySubjectIDsRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_NotificationService_GetNotificationBySubjectIDs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := server.GetNotificationBySubjectIDs(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterNotificationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NotificationServiceServer) error {
	...
	mux.Handle("GET", pattern_NotificationService_GetNotificationBySubjectIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NotificationService_GetNotificationBySubjectIDs_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_NotificationService_GetNotificationBySubjectIDs_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterNotificationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NotificationServiceClient) error {
	...
	mux.Handle("GET", pattern_NotificationService_GetNotificationBySubjectIDs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_NotificationService_GetNotificationBySubjectIDs_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_NotificationService_GetNotificationBySubjectIDs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"api", "subjectType", "me", "notification"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	forward_NotificationService_GetNotificationBySubjectIDs_0 = runtime.ForwardResponseMessage
