...
var (
	filter_HashTagService_GetHashTag_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_HashTagService_GetHashTag_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"api", "hashtag", "name", "conversations"}, "", runtime.AssumeColonVerbOpt(true)))
)
